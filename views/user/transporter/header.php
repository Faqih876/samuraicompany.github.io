	...
	<div id="wrapper">
    	...
    	<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
				...
				<div class="sidebar-brand-text mx-3"><img src="../../../assets/img/.png" width="80px" height="auto"></div>
			</a>
		    ...
		    <li class="nav-item <?php if (isset($menu4A)) echo $menu4A ?>">
		        <a class="nav-link" href="purch_order.php?page=4A">
		        <i class="fas fa-fw fa-list"></i>
		        <span>PURCHASE ORDER</span></a>
		    </li>

			<li class="nav-item <?php if (isset($menu3A)) echo $menu3A ?>">
		        <a class="nav-link" href="fleet_status.php?page=3A">
		        <i class="fas fa-fw fa-copy"></i>
		        <span>FLEET STATUS</span></a>
		    </li>

		    <li class="nav-item <?php if (isset($menu2A)) echo $menu2A ?>">
		        <a class="nav-link" href="shipment_status.php?page=2A">
		        <i class="fas fa-fw fa-chart-bar"></i>
		        <span>SHIPMENT STATUS</span></a>
		    </li>
